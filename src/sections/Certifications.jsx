        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="relative flex items-center gap-4">
              <button onClick={prev} className="flex-shrink-0 p-3 rounded-full bg-white dark:bg-gray-700 shadow-md hover:shadow-lg text-gray-600 dark:text-gray-300 hover:text-primary-light dark:hover:text-primary-light transition-all duration-200" aria-label="Previous">
              ...
              <button onClick={next} className="flex-shrink-0 p-3 rounded-full bg-white dark:bg-gray-700 shadow-md hover:shadow-lg text-gray-600 dark:text-gray-300 hover:text-primary-light dark:hover:text-primary-light transition-all duration-200" aria-label="Next">
              ...
              {certifications.map((_, i) => (
                <button
                  ...
                  className={`rounded-full transition-all duration-200 ${
                    i === currentIndex ? 'bg-primary-light w-6 h-2.5' : 'w-2.5 h-2.5 bg-gray-300 dark:bg-gray-600 hover:bg-gray-400'
                  }`}
                />
              ))}
            </div>
      ...
      <AnimatePresence>
        {selectedCert && (
          ...
          >
            ...
            >
              <button onClick={() => setSelectedCert(null)} className="absolute top-4 right-4 p-2 rounded-full text-gray-400 hover:text-gray-700 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
              ...
              <div className="flex items-center gap-5 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white leading-tight">{selectedCert.name}</h3>
              ...
              <div className="space-y-3">
                {[
                  ...
                  { label: t.certifications.modal.year, value: selectedCert.date, accent: true },
                  ...
                  <div key={label} className="flex items-center justify-between py-3 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <span className={`text-sm font-semibold ${accent ? 'text-primary-light' : 'text-gray-900 dark:text-white'}`}>{value}</span>
                  </div>
                ))}
